        ...
        try {
            const res = await fetch('/api/customers', {
                ...
                body: JSON.stringify({
                    ...
                    preExisting: selectedConditions.length > 0 ? JSON.stringify(selectedConditions) : null,
                }),
            })
    ...
    return (
        <div className="animate-fade-in" style={{ padding: '32px', maxWidth: '900px' }}>
            ...
            <div style={{
                ...
                <button style={tabStyle('basic')} onClick={() => setTab('basic')}>Basic Info</button>
                <button style={tabStyle('kyc')} onClick={() => setTab('kyc')}>KYC & Documents</button>
                <button style={tabStyle('health')} onClick={() => setTab('health')}>Health & Notes</button>
            </div>
